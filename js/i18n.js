...
const dict = {
  en: {
    ...
    checkout_info_eyebrow:"Almost there", checkout_info_title:"Delivery details",
    checkout_info_sub:"We'll use this to confirm and deliver your order — payment is cash on arrival.",
    checkout_name_label:"Full name", checkout_name_placeholder:"Your full name",
    checkout_phone_label:"Phone number", checkout_phone_placeholder:"e.g. 06XX-XXXXXX",
    checkout_address_label:"Delivery address", checkout_address_placeholder:"Street, building, floor…",
    checkout_city_label:"City", checkout_city_placeholder:"e.g. Casablanca",
    checkout_note_label:"Note (optional)", checkout_note_placeholder:"Anything we should know — landmark, preferred time…",
    checkout_place_order_btn:"Place order — cash on delivery", checkout_placing_btn:"Placing order…",
    checkout_info_fill_required:"Please fill in your name, phone, address and city.",
  ...
  fr: {
    ...
    checkout_info_eyebrow:"Presque fini", checkout_info_title:"Détails de livraison",
    checkout_info_sub:"Ces informations servent à confirmer et livrer votre commande — paiement en espèces à la réception.",
    checkout_name_label:"Nom complet", checkout_name_placeholder:"Votre nom complet",
    checkout_phone_label:"Numéro de téléphone", checkout_phone_placeholder:"ex. 06XX-XXXXXX",
    checkout_address_label:"Adresse de livraison", checkout_address_placeholder:"Rue, immeuble, étage…",
    checkout_city_label:"Ville", checkout_city_placeholder:"ex. Casablanca",
    checkout_note_label:"Remarque (optionnel)", checkout_note_placeholder:"Tout ce qu'il faut savoir — repère, heure préférée…",
    checkout_place_order_btn:"Passer la commande — paiement à la livraison", checkout_placing_btn:"Commande en cours…",
    checkout_info_fill_required:"Merci de renseigner votre nom, téléphone, adresse et ville.",
  ...
  ar: {
    ...
    checkout_info_eyebrow:"باقي شوية", checkout_info_title:"معلومات التوصيل",
    checkout_info_sub:"غادي نستعملو هاد المعلومات باش نأكدو ونوصلو طلبك — الدفع نقداً عند التوصيل.",
    checkout_name_label:"الاسم الكامل", checkout_name_placeholder:"اسمك الكامل",
    checkout_phone_label:"رقم الهاتف", checkout_phone_placeholder:"مثال 06XX-XXXXXX",
    checkout_address_label:"عنوان التوصيل", checkout_address_placeholder:"الزنقة، العمارة، الطابق…",
    checkout_city_label:"المدينة", checkout_city_placeholder:"مثال الدار البيضاء",
    checkout_note_label:"ملاحظة (اختياري)", checkout_note_placeholder:"أي حاجة خاصنا نعرفوها — علامة مميزة، الوقت المفضل…",
    checkout_place_order_btn:"أكد الطلب — الدفع عند الاستلام", checkout_placing_btn:"كنسجلو الطلب…",
    checkout_info_fill_required:"عافاك عمر الاسم، الهاتف، العنوان والمدينة.",
